  ...
  useEffect(() => {
    ...
    if (profile?.role === 'doctor') {
      ...
      if (profile.is_approved === false) {
        // Redirect unapproved doctors to pending approval page
        router.push('/auth/doctor/pending-approval');
        return;
      }

      // Doctor is approved - show the dashboard
      setIsDoctor(true);
      fetchDoctorData();
    } else {
      setIsDoctor(false);
            ...
            <div className="ml-3">
              ...
              <div className="mt-1 text-sm text-amber-700">
                <p>
                  ...
                  approval. Some features will be limited until your account is
                  approved. Our team will review your credentials and approve
